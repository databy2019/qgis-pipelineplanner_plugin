...
from .pipeline_planner_dialog import PipelinerPlannerDialog
import os.path


class PipelinerPlanner:
    ...
    def __init__(self, iface):
        ...
        #ctreated syntax by me to declare
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'PipelinerPlanner_{}.qm'.format(locale))
        ...
        # created syntax by me
        self.dlg = PipelinerPlannerDialog()
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PipelinerPlanner', message)
        ...
        if button == Qt.LeftButton:
            ...
            for raptor in raptors:
                ...
                if raptor.geometry().intersects(pipeline):
                    ...
                    self.dlg.tblImpacts.setItem(row, 3, QTableWidgetItem("{:4.5}".format(valDistance)))
